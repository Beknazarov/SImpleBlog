...
patterns = [
    ...
    Url(HTTP_METHODS.POST, '/admin/update/', views.update_method_post),
    Url(HTTP_METHODS.GET, '/admin/blog/', views.admin_page),
    Url(HTTP_METHODS.GET, '/admin/create/', views.create_post),
    Url(HTTP_METHODS.POST, '/admin/create/', views.create_post_method_post),
    Url(HTTP_METHODS.GET, '/register/', views.register),
    Url(HTTP_METHODS.POST, '/register/', views.register_method_post),
    Url(HTTP_METHODS.GET, '/logout/', views.logout),
    Url(HTTP_METHODS.GET, '/admin/', views.login),
    Url(HTTP_METHODS.POST, '/admin/', views.login_method_post),
